...
def make_stat():
    ...
    with open("telnet_session_URL_extractor.output", 'w') as f:
        f.write(str(to_write))
    with open("extracted_urls.output", 'w') as f:
        dico1 = {'type': 'url'}
        for url in urls:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Extract URL and IP from sessions')
